 ...
 *
 */
class Beausy_Service_Paypal_Data_ShipToAddress extends Beausy_Service_Paypal_Data_Abstract
{
  ...
  public function toArray()
  {
    ...
    // Required
    $array['SHIPTONAME'] = $this->_name;
    $array['SHIPTOSTREET'] = $this->_street;
    $array['SHIPTOCITY'] = $this->_city;
    $array['SHIPTOSTATE'] = $this->_state;
    $array['SHIPTOCOUNTRY'] = $this->_countryCode;

    // Optional
    if (!empty($this->_street2))
      $array['SHIPTOSTREET2'] = $this->_street2;

    // Optional for some countries
    if (!empty($this->_zip))
      $array['SHIPTOZIP'] = $this->_zip;

    // Optional
    if (!empty($this->_phone))
      $array['SHIPTOPHONENUM'] = $this->_phone;
